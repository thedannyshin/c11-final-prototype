...
export function drawPath(ctx, points, color, size) {
...
export function drawCharacterAt(ctx, character, cx, cy, maxSizePx, angle = 0) {
...
// per-frame.
export function renderStaticBg(bg, W, H) {
...
export function drawAnimatedPlants(ctx, bg, t, W, H) {
...
// Views
// ---------------------------------------------------------------------------
export function AquariumHostView({ room, clientId, clientColor, onResetRoom }) {
  const shared = useSharedRoom(room, { clientId, name: 'Host', role: 'host', color: clientColor });
...
export function AquariumParticipantView({ room, clientId, clientColor }) {
  const shared = useSharedRoom(room, { clientId, name: 'Anonymous', role: 'participant', color: clientColor });
  return (
